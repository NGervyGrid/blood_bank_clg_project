...
<body>
<?php include('admin/php/function.php'); ?>
...
$s="select * from reg,location where reg.area='". $_REQUEST["bg"]."' and reg.area=location.l_id";
           ...
           <tr><td colspan="2">&nbsp;</td></tr>
                <tr><td><span class="title">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td><td><?php echo $data[0]; ?></td><td align="left" width="50%"></td></tr>
                 <tr><td><span class="title">Gender</span></td><td><?php echo $data[1]; ?></td></tr>
                  <tr><td style="width:24px"><span class="title">Mobile No:</span></td><td><?php echo $data[3]; ?></td></tr>
                  <tr><td><span class="title">Email</span></td><td><?php echo $data[5]; ?></td></tr><tr><td><span class="title">Blood Group</span></td><td><?php echo $data[4]; ?></td></tr>
                     <tr><td colspan="2">&nbsp;</td></tr>
