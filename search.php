...
<div style="height:350px;">
   ...
   <table cellpadding="0" cellspacing="0" width="500px" height="250px" class="tableborder" style="margin:auto; margin-top:100px;" >
        ...
        <tr><td colspan="2" align="center"><img src="Images/location.png" height="80px" /></td></tr>
        <tr><td colspan="2">&nbsp;</td></tr>
        <tr><td class="lefttd" style="padding-left:40px">Select Area </td><td><select name="s2" required><option value="">Select</option>
...
{
$cn=mysqli_connect("localhost","root","","blood");
$s="select * from location where l_id='" .$_POST["s2"] ."'";
	$result=mysqli_query($cn,$s);
	$r=mysqli_num_rows($result);
	//echo $r;
